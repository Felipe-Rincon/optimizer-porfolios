...
# strategy_allocation = st.Page(
#     "pages/1_Strategy_Allocation.py", title="Strategy Allocation Optimization", icon="📊", default=True
# )
# tactical_allocation = st.Page(
#     "pages/2_Tactical_Allocation.py", title="Tactical Allocation Optimization", icon="📈"
# )
# backtesting = st.Page(
#     "pages/3_Backtesting.py", title="Backtesting", icon="📈"
# )
